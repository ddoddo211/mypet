...
<head>
<meta charset="UTF-8">
<title>completion.jsp(관리자 - 보험청구 관리(완료))</title>
		...
		<%@include file="../adminHeader.jsp"%>
			...
			<div id="claimMain">
					<div id="claimTitle">
						...
						<div id="claimPetInfo">
							보험금 완료처리된 펫 : ${acdVo.myp_name}&nbsp;&nbsp;/&nbsp;&nbsp;<fmt:formatDate value="${acdVo.myp_birth}" pattern="yy년 MM월 dd일"></fmt:formatDate>&nbsp;&nbsp;/&nbsp;&nbsp;${acdVo.myp_gender}&nbsp;&nbsp;/&nbsp;&nbsp;${acdVo.myp_sick}
						</div>
						
						<div class="claimTitle4">
							<div class="claimTitle4_1">
								<div class="claimTitle4_2">Step1. "${acdVo.mem_name}"께서 완료된 보험금 청구상품</div>
							</div>
						</div>
		...
		․위 정보의 수집·이용에 관한 동의는 거부하실 수 있으며, 다만 동의하지 않으시는 경우 채용심사상의 불이익을 받으실 수 있습니다.
					...
					<div id="insurer">
							<div id="insurer1">
								...
								<div class="insurer2_1">
									<label class="insurer2_4" >${acdVo.accd_insp}원</label>
								</div>
								<div class="insurer2_2">
									지급일자
								</div>
								<div class="insurer2_3">
									<label class="insurer2_4"><fmt:formatDate value="${acdVo.accd_date}" pattern="yyyy년 MM월 dd일"/> </label>
								</div>
